...
function Footer() {
    return (
        <footer class="p-4 bg-black md:p-8 lg:p-10 dark:bg-gray-800">
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
          ...
          <li>
              <Link href="#" class="mr-4 hover:underline md:mr-6">Premium</Link>
          </li>
          <li>
              <Link href="#" class="mr-4 hover:underline md:mr-6 ">Campaigns</Link>
          </li>
          <li>
              <Link href="#" class="mr-4 hover:underline md:mr-6">Blog</Link>
          </li>
          <li>
              <Link href="#" class="mr-4 hover:underline md:mr-6">Affiliate Program</Link>
          </li>
          <li>
              <Link href="#" class="mr-4 hover:underline md:mr-6">FAQs</Link>
          </li>
          <li>
              <Link href="#" class="mr-4 hover:underline md:mr-6">Contact</Link>
          </li>
      </ul>
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {new Date().getFullYear()} Nevindu Heshan</span>
  </div>
</footer>
    );
}
