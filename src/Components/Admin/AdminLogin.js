...
const AdminLogin = () => {
    ...
    return (
        <div>
            <section class="bg-[url('https://images.pexels.com/photos/5946646/pexels-photo-5946646.jpeg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply bg-opacity-60">
                    ...
                    <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800">
                        <div class="p-6 space-y-4 md:space-y-6 lg:space-y-8 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                                ...
                                <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Log in to Admin account</button>
